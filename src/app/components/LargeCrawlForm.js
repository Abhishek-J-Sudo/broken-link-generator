    ...
    <div className="w-full p-6 bg-white rounded-lg shadow-lg">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Enter a URL to start checking for broken links. This traditional crawler discovers pages
          and checks links as it goes. For large sites or advanced analysis, try our{' '}
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-md">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">How Traditional Crawling Works</h3>
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                <li>Starts from your homepage and discovers pages by following links</li>
                <li>Checks each link for accessibility as it goes</li>
                <li>Crawls up to the specified depth level</li>
                <li>Provides real-time progress updates</li>
                <li>Works well for most websites up to medium size</li>
              </ul>
            </div>
          </div>
        </div>
